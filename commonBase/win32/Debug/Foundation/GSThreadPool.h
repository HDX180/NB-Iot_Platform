...
typedef  void  (XC_CALLBACK *FunPtrThreadPoolCallback)( void *pUserParam  );
...
private :
	static  void XC_CALLBACK ThreadProxy(GSThread &thread, void *data);
	void ThreadEntry(GSThread &thread);

	void AddThread(void);
	XC_CLASS_NOCOPY(GSThreadPool)
};
...
typedef  void  (XC_CALLBACK *FunPtrRefThreadPoolCallback)( void *pUserParam, long lThreadID  );
...
protected :
	...
	XC_CLASS_NOCOPY(GSRefThreadPool)
};
...
typedef void (XC_CALLBACK *FunPtrTaskPoolCallback)(void *pTaskData, void *pUserData);
...
private :
	static void XC_CALLBACK DoTaskEventProxy(void *pTaskData, void *pUserData)
	{
		CObjectTaskPool *p = (CObjectTaskPool*)pUserData;
		(p->m_pFunOwner->*(p->m_fnTaskCb))(*p, pTaskData );
	}
	static void XC_CALLBACK DoFreeTaskDataEventProxy(void *pTaskData, void *pUserData)
	{
		CObjectTaskPool *p = (CObjectTaskPool*)pUserData;
